<template>
    <div id="app">
        <!--
            ...
            &lt;!&ndash;router-view其实就是页面变化的具体内容所在位置，例如：home切换到about&ndash;&gt;
            &lt;!&ndash;要使用动画，请将router-view用trasition标签包裹起来,appearActiveClass用于设置想要用什么动画,
            设置的是第一次出现页面时的动画，enterActiveClass：用于设置页面切换时动画&ndash;&gt;
